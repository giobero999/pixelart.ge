          ...
          <div class="pt40">
            <div class="row ">
              <div class="col-sm-12 col-md-6">
                <img src="imgs/products/11.jpg" alt="" class="img-responsive"/>
              </div>
              <div class="col-sm-12 col-md-6">
                <h3 class="main-title">Amazon Fire TV Stick</h3>
                <h4 i>მოდელი:</i> <span class="red-color">Fire TV Stick</span></h4>
                <hr>
                  ...
                  <div class="row">
                    <div class="col-md-12" >
                      ...
                      <ul class="list-group features-list">
                        ...
                        <li class="">
                          <i>პროცესორი:</i> Broadcom, Dual-core 2xARM A9 up to 1 GHz
                        </li>
                        <li>
                          <i>გარე მეხსიერება:</i> 8 GB
                        </li>
                        <li>
                          <i>ოპერაციული მეხსიერება:</i> 1GB
                        </li>
                        <li>
